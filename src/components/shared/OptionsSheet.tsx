 ...
 * Lulu, not a bare system menu). Also sidesteps a real bug ActionSheetIOS
 * has here: calling showActionSheetWithOptions immediately after another
 * Modal finishes dismissing can silently no-op mid-transition (PRD bug
 * report: "tapping Add Assets no longer works" right after completing the
 * Debt step's own sheet) — this is a plain JS-rendered Modal, so there's no
 * native view-controller race to hit.
 */
